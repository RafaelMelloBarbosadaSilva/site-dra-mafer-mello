...
export default function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed right-6 bottom-6 z-40 bg-brand-600 text-white font-bold px-5 py-3.5 rounded-full shadow-2xl hover:bg-brand-700 hover:scale-105 active:scale-95 transition-all duration-300 flex items-center gap-2.5 group border border-white/20"
    >
